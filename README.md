...
Cinque figure di presidio su paid media, SEO, design, privacy e legale, più `grl-ads` per audit, piani, tracking, preflight e change set Google Ads e `grl-automation` per i passaggi ripetitivi. Dalia tiene la spesa sotto controllo: nessuna campagna si pubblica senza evidenze, approvazione e rollback.
