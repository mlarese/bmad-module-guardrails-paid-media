# Guardrails Paid Media (`gpm`) — istruzioni di progetto
...
fonte, poi `python3 tools/build_modules.py --module gpm`, poi commit qui.

## Cosa cambia rispetto al bundle

- il roster contiene solo le figure di quest'area
- le tre skill del core sono rinominate: `gpm-setup`, `gpm-profile`,
  `gpm-board`
